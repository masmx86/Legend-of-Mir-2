...
namespace Client.MirScenes
{
    public class SelectScene : MirScene
    {
        ...
        public void StartGame()
        {
            ...
            // Update the form title to include the character name
            Program.Form.Text = $"{GameLanguage.ClientTextMap.GetLocalization(ClientTextKeys.GameName)} - {Characters[_selected].Name}";
        }
